...
<div class="container">
    <form id="contact" action="controller/UrunController.php" method="post">
        ...
        <fieldset>
            ...
            <input id="urunAd" name="urun_ad" required type="text" tabindex="1">
        </fieldset>
        ...
        <fieldset>
            ...
            <textarea id="urunTanitim" name="urun_tanitim" required style="width: 100%" ></textarea>
        </fieldset>

        <fieldset>
            <label for="urunVideo">Ürün Video Link</label>
            <input id="urunVideo" name="urun_video" type="text" tabindex="1">
        </fieldset>

        <fieldset>
            <label for="satisFiyat">Satış Fiyatı</label>
            <input id="satisFiyat" name="satis_fiyat" type="number" min="0" required step="0.01" tabindex="1"">
        </fieldset>
