...
function hideInformation($str, $start, $end){
    //parametre olarak belirttiğimiz değişken içerisindeki veriyi, parametrede belirtilen değere göre alıp yeni bir değişkene depolar.
    $after = mb_substr($str, 0, $start, 'utf8');
    //işlevi bir dizeyi belirtilen sayıda yineler.
    $repeat = str_repeat('*', $end);
    //Birleştirme işlemi yapılıyor
